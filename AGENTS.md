...
- `internal/docs/agent-workflows/multi-batch-operations.md`: operator guide for multiple concurrent batches across machines, launch surfaces, or the React on Rails / RSC repos
...
| `docs/`               | Public documentation boundary README; not the maintainer doc tree          |
| `internal/docs/`      | Internal release, agent workflow, operator, audit, and implementation docs |
...
`$rsc-update-changelog` and `internal/docs/releasing.md`.
