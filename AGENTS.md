...
- `docs/internal/contributor-info/multi-batch-operations.md`: operator guide for multiple concurrent batches across machines, launch surfaces, or the React on Rails / RSC repos
...
| `docs/`               | Internal documentation boundary and maintainer docs                        |
| `docs/internal/`      | Internal release, contributor, operator, audit, and implementation docs    |
...
`$rsc-update-changelog` and `docs/internal/releasing.md`.
