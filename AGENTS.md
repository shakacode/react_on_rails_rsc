...
- `internal/docs/contributor-info/multi-batch-operations.md`: operator guide for multiple concurrent batches across machines, launch surfaces, or the React on Rails / RSC repos
...
| `internal/docs/`      | Internal release, contributor, operator, audit, and implementation docs    |
