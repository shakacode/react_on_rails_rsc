...
component of React on Rails Pro under The React on Rails Pro License, version
3.0: free in development, test, CI, and staging for everyone, free in production
