...
This repository's checked-in documentation is internal maintainer guidance for
the `react-on-rails-rsc` package.

Public React Server Components documentation for application developers belongs
in downstream React on Rails documentation:
