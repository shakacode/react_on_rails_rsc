...
| [`$rsc-triage`](../../../.agents/skills/rsc-triage/SKILL.md) | The open RSC work status or backlog map needs a live refresh. | A verified live-state summary or an updated `internal/docs/open-rsc-work-status.md`. |
